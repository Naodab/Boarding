...
<div class="sidebar closure">
	<div class="sidebar-header">
		...
		<a href="<%= request.getContextPath() %>/boardingFees" id="fees"><i class="fa-solid fa-money-check-dollar"></i>Quản lý đợt thu tiền</a>
		<a href="<%= request.getContextPath() %>/invoices" id="invoices"><i class="fa-solid fa-file-invoice"></i>Quản lý hóa đơn</a>
		...
		<a href="<%= request.getContextPath() %>/accounts" id="accounts"><i class="fa-solid fa-user"></i>Quản lý tài khoản</a>
	</div>
